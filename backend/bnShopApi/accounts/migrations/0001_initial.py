    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follow', models.ManyToManyField(blank=True, related_name='followed', to='accounts.agency')),
            ],
        ),
        migrations.CreateModel(
            name='Visit',
            fields=[
                ...
                ('agency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='agency_visited', to='accounts.agency')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_visit', to='accounts.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Users',
        ...
        migrations.AddField(
            model_name='customer',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='customer', to='accounts.users'),
        ),
        migrations.AddField(
            model_name='customer',
            name='visit',
            field=models.ManyToManyField(blank=True, related_name='visited', through='accounts.Visit', to='accounts.agency'),
        ),
        migrations.AddField(
            model_name='agency',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='agency', to='accounts.users'),
        ),
    ]
